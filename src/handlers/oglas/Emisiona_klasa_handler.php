...
class Emisiona_klasa_handler implements Oglas_handler
{
	...
	public function process(Oglas $oglas, array $input): bool
	{
		...
		if (isset($input["emisiona_klasa_motora"]) && $input["emisiona_klasa_motora"] != "" && $oglas->getEmisiona_klasa_motora()->get_id() != intval($input["emisiona_klasa_motora"]))
			return false;
