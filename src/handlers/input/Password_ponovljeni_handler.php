...
/**
 * Proverava da li se password i repassword poklapaju,
 * cuva rezultat u $GLOBALS['lozinke_se_ne_poklapaju']
 */
class Password_ponovljeni_handler implements Input_handler
{
	...
	public function process(array $input): bool
	{
		...
		$GLOBALS['lozinke_se_ne_poklapaju'] = $input["password"] != $input["repassword"];

		if ($GLOBALS['lozinke_se_ne_poklapaju'])
        	return false;
